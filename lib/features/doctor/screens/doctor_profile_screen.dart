                      ...
                      InformationItem(
                        ...
                        title: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(width: 1, color: Colors.grey)),
                          child: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : "${controller.listRecord[controller.selectRecord.value]?.temperature}*C",
                            style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0),
                      ...
                      InformationItem(
                        ...
                        title: Container(
                          ...
                          child: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : "${controller.listRecord[controller.selectRecord.value]?.height} cm",
                            style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0),
                      ...
                      InformationItem(
                        ...
                        title: Container(
                          ...
                          child: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : "${controller.listRecord[controller.selectRecord.value]?.weight} Kg",
                            style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0),
                      ...
                      InformationItem(
                        ...
                        title: Container(
                          ...
                          child: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : "${controller.listRecord[controller.selectRecord.value]?.bloodPressure} mmHg",
                            style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                                fontSize: 14.0),
                      ...
                      InformationItem(
                        ...
                        title: Container(
                          ...
                          child: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : DateFormat().add_yMEd().format(controller
                                    .listRecord[controller.selectRecord.value]!
                                    .dateCreate),
                            style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        InformationItem(
                          ...
                          title: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : '\$${controller.listRecord[controller.selectRecord.value]!.totalMoney}',
                            style: const TextStyle(
                        ...
                        InformationItem(
                          ...
                          title: Text(
                            controller.listRecord.isEmpty
                                ? ""
                                : DateFormat().add_yMd().format(controller
                                    .listRecord[controller.selectRecord.value]!
                                    .dateCreate),
                            style: const TextStyle(
                                color: AppColors.primaryColor,
